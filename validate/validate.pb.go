...
func (x *StringRules) GetDateTime() bool {
	if x, ok := x.GetWellKnown().(*StringRules_DateTime); ok {
		return x.DateTime
	}
	return false
}

func (x *StringRules) GetOptionalDateTime() bool {
	if x, ok := x.GetWellKnown().(*StringRules_OptionalDateTime); ok {
...
type StringRules_DateTime struct {
	// DateTime specifies that the field must be a valid DateTime as defined
	// by RFC 3339
	DateTime bool `protobuf:"varint,27,opt,name=date_time,json=dateTime,oneof"`
}

type StringRules_OptionalDateTime struct {
	// OptionalDateTime specifies that the field must be either empty or a
	// valid DateTime as defined by RFC 3339
	OptionalDateTime bool `protobuf:"varint,28,opt,name=optional_date_time,json=optionalDateTime,oneof"`
}
...
var file_validate_validate_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x63, 0x6f, 0x6e, 0x73, 0x74, 0x22, 0xa3, 0x06, 0x0a, 0x0b, 0x53, 0x74, 0x72, 0x69,
	...
	0x1d, 0x0a, 0x09, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x1b, 0x20, 0x01,
	0x28, 0x08, 0x48, 0x00, 0x52, 0x08, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x2e,
	0x0a, 0x12, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x5f, 0x64, 0x61, 0x74, 0x65, 0x5f,
	0x74, 0x69, 0x6d, 0x65, 0x18, 0x1c, 0x20, 0x01, 0x28, 0x08, 0x48, 0x00, 0x52, 0x10, 0x6f, 0x70,
	0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x44, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x1c,
